...
object DefaultCategories {
    val list: List<Category> = listOf(
        ...
        Category(name = "Bills & Utilities", icon = "bolt", colorHex = "#FFC107", transactionType = TransactionType.EXPENSE, isDefault = true),
        ...
        Category(name = "Medical", icon = "local_hospital", colorHex = "#F44336", transactionType = TransactionType.EXPENSE, isDefault = true),
        Category(name = "Education", icon = "school", colorHex = "#3F51B5", transactionType = TransactionType.EXPENSE, isDefault = true),
        Category(name = "Travelling", icon = "directions_car", colorHex = "#9C27B0", transactionType = TransactionType.EXPENSE, isDefault = true),
        Category(name = "Investments", icon = "trending_up", colorHex = "#FF9800", transactionType = TransactionType.EXPENSE, isDefault = true),
        ...
        Category(name = "Taxes", icon = "monetization_on", colorHex = "#795548", transactionType = TransactionType.EXPENSE, isDefault = true),
